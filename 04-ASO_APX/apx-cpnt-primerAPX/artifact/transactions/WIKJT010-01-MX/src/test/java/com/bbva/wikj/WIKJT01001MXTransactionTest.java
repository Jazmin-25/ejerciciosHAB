...
/**
 * Test for transaction WIKJT01001MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT01001MXTest.xml" })
public class WIKJT01001MXTransactionTest {

	@Autowired
	private WIKJT01001MXTransaction transaction;
